        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-3xl mx-auto">
              Anonymous, compassionate AI-powered conversations to help you
              navigate life's challenges. Available 24/7, completely free.
            </p>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              Advanced AI understands your emotional state to provide
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-lg">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              100% anonymous conversations. No personal information ever
              required
            </p>
          </div>
